...
class ITSEC_Sync_Connect {
	...
	public function run() {
		...
		pbhs_add_action( 'login_form', array( $this, 'ferry_sync_connect_token' ) );
		pbhs_add_action( 'itsec_initialize_login_interstitial_session_from_global_state', array( $this, 'set_sync_token_meta' ) );
		pbhs_add_filter( 'itsec_rest_supports', array( $this, 'add_sync_connect_to_rest_supports' ) );
	}
