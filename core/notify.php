...
class ITSEC_Notify {
	...
	public function __construct() {
		...
		pbhs_add_filter( 'itsec_digest_notification_strings', array( $this, 'notification_strings' ) );
		pbhs_add_filter( 'itsec_send_notification_digest', array( $this, 'send_daily_digest' ), 10, 3 );
	}
