...
if ( version_compare( phpversion(), '5.6.0', '<' ) ) {
	...
	pbhs_add_action( 'admin_notices', 'itsec_free_minimum_php_version_notice' );
...
if ( version_compare( $GLOBALS['wp_version'], '5.2.0', '<' ) ) {
	...
	pbhs_add_action( 'admin_notices', 'itsec_minimum_wp_version_notice' );
...
pbhs_add_action( 'plugins_loaded', 'itsec_load_textdomain' );
