...
final class ITSEC_Settings_Page {
	...
	private function __construct() {
		pbhs_add_action( 'itsec-settings-page-register-module', array( $this, 'register_module' ) );
		pbhs_add_action( 'itsec-settings-page-register-widget', array( $this, 'register_widget' ) );

		pbhs_add_action( 'itsec-page-show', array( $this, 'handle_page_load' ) );
		pbhs_add_action( 'itsec-page-ajax', array( $this, 'handle_ajax_request' ) );
		pbhs_add_action( 'admin_print_scripts', array( $this, 'add_scripts' ) );
		pbhs_add_action( 'admin_print_styles', array( $this, 'add_styles' ) );

		pbhs_add_filter( 'admin_body_class', array( $this, 'add_settings_classes' ) );
