...
class ITSEC_Ban_Users {
	...
	public function add_hooks() {
		...
		pbhs_add_filter( 'itsec_filter_blacklisted_ips', array( $this, 'filter_blacklisted_ips' ) );
	...
	public function remove_hooks() {
		pbhs_remove_filter( 'itsec_filter_blacklisted_ips', array( $this, 'filter_blacklisted_ips' ) );
