...
final class ITSEC_Away_Mode {
	...
	public function run() {
		...
		pbhs_add_action( 'admin_init', array( $this, 'run_active_check' ) );
		pbhs_add_action( 'login_init', array( $this, 'run_active_check' ) );

		pbhs_add_filter( 'itsec_managed_files', array( $this, 'register_managed_file' ) );
