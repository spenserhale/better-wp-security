...
class ITSEC_Notification_Center_Debug {
	...
	public function __construct() {
		pbhs_add_action( 'itsec_debug_page', array( $this, 'render' ) );
		pbhs_add_action( 'itsec_debug_page_enqueue', array( $this, 'enqueue_scripts_and_styles' ) );
		pbhs_add_action( 'itsec_debug_module_request_notification-center', array( $this, 'handle_ajax_request' ) );
	}
