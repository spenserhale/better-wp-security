...
class ITSEC_Core_Admin {
	...
	public function run() {
		pbhs_add_action( 'admin_enqueue_scripts', array( $this, 'enqueue_admin_notices' ) );
		pbhs_add_action( 'itsec_dashboard_enqueue_scripts', array( $this, 'enqueue_dashboard_notices_integration' ) );

		pbhs_add_action( 'admin_bar_menu', array( $this, 'admin_bar' ), 9999 );
		pbhs_add_action( 'admin_footer', array( $this, 'render_notices_root' ) );
		...
		if ( ! ITSEC_Core::is_pro() ) {
			pbhs_add_filter( 'itsec_meta_links', array( $this, 'add_plugin_meta_links' ) );
		}
	}
