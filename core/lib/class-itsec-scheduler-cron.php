...
class ITSEC_Scheduler_Cron extends ITSEC_Scheduler {
	...
	public function run() {
		pbhs_add_action( self::HOOK, array( $this, 'process' ), 10, 2 );
		pbhs_add_filter( 'cron_schedules', array( $this, 'register_cron_schedules' ) );
	}
	...
	public function uninstall() {
		pbhs_remove_action( self::HOOK, array( $this, 'process' ) );
		pbhs_remove_filter( 'cron_schedules', array( $this, 'register_cron_schedules' ) );
