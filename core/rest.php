...
class ITSEC_REST {
	public function run() {
		pbhs_add_action( 'rest_api_init', array( $this, 'rest_api_init' ), 0 );
		pbhs_add_filter( 'rest_response_link_curies', array( $this, 'register_curie' ) );
		pbhs_add_filter( 'rest_namespace_index', array( $this, 'modify_index' ) );
		pbhs_add_filter( 'rest_user_collection_params', [ $this, 'register_global_users_query' ] );
		pbhs_add_filter( 'rest_user_query', [ $this, 'apply_global_users_query' ], 10, 2 );
	}
