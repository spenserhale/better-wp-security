...
class ITSEC_Core_Active {
	...
	public function run() {
		pbhs_add_action( 'wp_enqueue_scripts', array( $this, 'register_scripts' ), 0 );
		pbhs_add_action( 'login_enqueue_scripts', array( $this, 'register_scripts' ), 0 );
		pbhs_add_action( 'admin_enqueue_scripts', array( $this, 'register_scripts' ), 0 );
	}
