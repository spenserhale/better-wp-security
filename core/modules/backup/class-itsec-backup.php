...
class ITSEC_Backup {
	...
	function run() {
		...
		pbhs_add_action( 'itsec_execute_backup_cron', array( $this, 'do_backup' ) );

		pbhs_add_filter( 'itsec_notifications', array( $this, 'register_notification' ) );
		pbhs_add_filter( 'itsec_backup_notification_strings', array( $this, 'notification_strings' ) );
		...
		pbhs_add_action( 'itsec_scheduled_backup', array( $this, 'scheduled_callback' ) );
	}
