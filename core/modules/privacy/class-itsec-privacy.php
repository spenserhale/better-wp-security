...
final class ITSEC_Privacy {
	public function run() {
		pbhs_add_action( 'admin_init', array( $this, 'admin_init' ) );
		pbhs_add_filter( 'wp_privacy_personal_data_exporters', array( $this, 'register_exporter' ) );
		pbhs_add_filter( 'wp_privacy_personal_data_erasers', array( $this, 'register_eraser' ) );
	}
