...
class Module implements Runnable {
	...
	public function run() {
		pbhs_add_action( 'itsec_initialized', [ $this, 'trigger_setting_registration' ] );
		pbhs_add_filter( 'map_meta_cap', [ $this, 'map_meta_cap' ], 10, 4 );
		pbhs_add_action( 'itsec_create_user_group', [ $this, 'initialize_settings' ] );
	}
