...
pbhs_add_filter( 'itsec_white_ips', 'itsec_global_filter_whitelisted_ips', 0 );
...
pbhs_add_action( 'init', 'itsec_cron_test_fail_safe' );
...
pbhs_add_action( 'itsec_cron_test', 'itsec_cron_test_callback' );
...
pbhs_add_action( 'wp_login', 'itsec_record_first_login', 15, 2 );
...
pbhs_add_filter( 'wp_update_attachment_metadata', 'itsec_basename_attachment_thumbs' );
...
pbhs_add_action( 'itsec_register_user_group_settings', 'itsec_register_global_user_group_settings', 0 );
