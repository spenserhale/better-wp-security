...
class ITSEC_Settings_Page_Sidebar_Widget {
	...
	public function __construct() {
		pbhs_add_action( 'itsec-settings-page-register-widgets', array( $this, 'register' ), $this->priority );
		pbhs_add_action( 'itsec-logs-page-register-widgets', array( $this, 'register' ), $this->priority );
	}
