...
final class ITSEC_Strong_Passwords implements Runnable {
	...
	public function run() {
		pbhs_add_action( 'itsec_register_password_requirements', array( $this, 'register_requirements' ) );
		pbhs_add_action( 'itsec_register_user_group_settings', [ $this, 'register_group_setting' ] );
		pbhs_add_action( 'admin_enqueue_scripts', array( $this, 'add_scripts' ) );
		pbhs_add_action( 'resetpass_form', array( $this, 'add_scripts_to_wp_login' ) );
		pbhs_add_action( 'itsec_password_requirements_change_form', array( $this, 'add_scripts_to_wp_login' ) );
	}
