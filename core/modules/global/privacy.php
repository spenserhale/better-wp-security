...
final class ITSEC_Global_Privacy {
	...
	public function __construct() {
		...
		pbhs_add_filter( 'itsec_get_privacy_policy_for_security_logs', array( $this, 'get_privacy_policy_for_security_logs' ) );
		pbhs_add_filter( 'itsec_get_privacy_policy_for_retention', array( $this, 'get_privacy_policy_for_retention' ) );
	}
