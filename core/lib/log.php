...
final class ITSEC_Log {
	 ...
	 */
	public static function pbhs_add_action( $module, $code, $data = false, $overrides = array() ) {
...
pbhs_add_action( 'itsec_scheduler_register_events', array( 'ITSEC_Log', 'register_events' ) );
pbhs_add_action( 'itsec_scheduled_purge-log-entries', array( 'ITSEC_Log', 'purge_entries' ) );
