...
pbhs_add_action( 'ithemes_sync_register_verbs', 'itsec_security_check_register_sync_verbs' );
...
pbhs_add_action( 'admin_post_nopriv_itsec-check-loopback', 'itsec_security_check_loopback_callback' );
