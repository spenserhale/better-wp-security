...
final class ITSEC_Storage {
	...
	private function __construct() {
		...
		pbhs_add_action( 'shutdown', array( $this, 'shutdown' ), -10 );

		pbhs_add_action( 'itsec-lib-clear-caches', array( $this, 'save' ), -20 );
		pbhs_add_action( 'itsec-lib-clear-caches', array( $this, 'load' ), -10 );
	}
